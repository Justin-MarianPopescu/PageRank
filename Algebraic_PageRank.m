function [PageRank] = Algebraic_PageRank(file, damp_fact)
    % @brief Calculate the page rank starting from a
    % hyperlinks matrix. With GramSchmidth we can calculate the ivers of 
    % a matrix and with the Grade Matrix we can calculate the PageRank
    % vector for all pages.
    %
